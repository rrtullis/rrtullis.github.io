...
## Data Info
This page contains a high-level overview of the dataset used for this analysis. Information regarding the meaning of each column was limited - most of the descriptions listed below were based on manual inspection of the data and domain knowledge.
...
| support_email | Email address of the game's customer support team | str | N |
...
| recomendations | The total number of reccomendations the game has recieved |int | Y |
...
| packages | List of dictionaries of different bundles and/or editions of the game available for purchase | list of dict | N |
...
| positive | Number of positive user votes, per SteamSpy |int | Y |
| negative | Number of negative user votes, SteamSpy | int | Y |
